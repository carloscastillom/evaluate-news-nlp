...
1. Clone the reposotorie
2. CD new folder 'evaluate-news-nlp'
3. make sure you have node install in your computer.
4. npm -i will install all the dependencies
5
